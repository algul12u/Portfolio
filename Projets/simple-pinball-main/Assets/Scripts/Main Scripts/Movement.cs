...
public class Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.LeftControl) || Input.GetKeyDown(KeyCode.LeftApple))
            // Ligne supprimée : Inventory.UseItem();
            ; // Remplacer par un point-virgule pour ne rien faire

        // Ligne supprimée : if (Input.GetKeyDown(KeyCode.LeftControl) || Input.GetKeyDown(KeyCode.LeftApple)) Inventory.UseItem();
    }
